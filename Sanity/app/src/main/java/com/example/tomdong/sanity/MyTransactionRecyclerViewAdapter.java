...
import com.example.tomdong.sanity.TransactionFragment.OnListFragmentInteractionListener;
...
public class MyTransactionRecyclerViewAdapter extends RecyclerView.Adapter<MyTransactionRecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.trans_id);
            mContentView = (TextView) view.findViewById(R.id.trans_content);
        }
