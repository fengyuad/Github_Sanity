...
import com.example.tomdong.sanity.CategoryFragment.OnListFragmentInteractionListener;
...
public class MyCategoryRecyclerViewAdapter extends RecyclerView.Adapter<MyCategoryRecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.cat_id);
            mContentView = (TextView) view.findViewById(R.id.cat_content);
        }
