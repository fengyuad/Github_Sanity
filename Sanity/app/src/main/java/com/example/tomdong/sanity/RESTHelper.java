...
public class RESTHelper {
    ...
    private static final String URL_POST = "http://api.taggun.io/api/receipt/v1/simple/file";
    private static final String URL_GET = "http://api.taggun.io";
